...
class UserController extends Controller
{
    ...
    {
        $users = User::all(); //
        return view('users.index', compact('users')); // tampilkan view file index didalam folder user kirim ke user
    }
     ...
     */
    public function store(Request $request) // mengambil data bentuk reques
    {
        // memvalidasi inputan
        $this->validate($request, [ // memvalidasi data required artinya harus ada
            'name'      => 'required',
